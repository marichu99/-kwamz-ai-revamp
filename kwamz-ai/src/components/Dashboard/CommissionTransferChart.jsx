...
function CommissionTransferChart({ data = [], growth = 0, isOnboarding = false }) {
    ...
    return (
      <div className='bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-2xl p-6 border border-slate-200/50 dark:border-slate-700/50'>
        <div className='flex items-center justify-between mb-6'>
          <h3 className='text-xl font-bold text-slate-800 dark:text-white'>MMF Commission Transfers</h3>
        </div>
          ...
          {isOnboarding ? (
            <>
              ...
              <p className="text-sm font-medium text-slate-500 dark:text-slate-400">
                MMF commission transfers will appear here once your company information has been onboarded to the system.
              </p>
            </>
          ) : (
    ...
    <div className='bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl rounded-2xl p-6 border border-slate-200/50 dark:border-slate-700/50 hover:shadow-2xl transition-all duration-300'>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <AreaChart data={chartData}>
          <defs>
            <linearGradient id="colorMmfTransfer" x1="0" y1="0" x2="0" y2="1">
...
export default CommissionTransferChart
